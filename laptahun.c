...
void laptahun(){
    ...
    }else if ((b=fopen("barang.dat","rb"))==NULL)
    {
       printf("Tidak dapat membuka file.\n");
        ...
        int tahun,pendapatan=0,pbersih=0,sumorder=0,found=0;
        while(1){
        found = 0;
        ...
        if (found==0)
        {
            printf("Tidak ada transaksi pada tahun tersebut.\n");
        }
        }
        printf("\n");
        printf("------------------------------------------------------------------------------\n");
        printf("Penjualan total pada tahun %d sebesar: %-7d\n",order.y,pendapatan);
        printf("Pendapatan bersih pada tahun %d sebesar: %-7d\n",order.y,pbersih);
